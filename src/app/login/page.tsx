        ...
        <div className="auth-showcase-inner">
          ...
          <div className="hero-copy">
            <span className="eyebrow bright">
              A casa organizada, sem planilha perdida
            </span>
            <h1>Contas, pagamentos e rotina em um só lugar.</h1>
            <p>
              Um painel privado para os cinco moradores acompanharem tudo.
              Somente o Vitor administra e altera os dados.
            </p>
          </div>
          <div className="feature-grid">
            <div className="feature-card">
              <WalletIcon />
              <strong>Finanças claras</strong>
              <span>Divisão igual ou personalizada, por mês.</span>
            </div>
            <div className="feature-card">
              <SparkIcon />
            ...
            <div className="feature-card">
              <CheckIcon />
              <strong>Sem cobrança confusa</strong>
              <span>Status individual e alertas de vencimento.</span>
            </div>
          </div>
        </div>
      </section>
      <section className="auth-panel">
        <div className="auth-card">
          ...
          <p className="muted-text">
            Use o e-mail cadastrado para acompanhar as despesas e tarefas.
          </p>
          {params.success && (
          ...
          <details className="signup-details">
            ...
            <form action={signup} className="stack-form compact-form">
              ...
              <button className="button secondary wide" type="submit">
                Solicitar acesso
              </button>
            </form>
          </details>
          <small className="security-note">
            Os dados ficam protegidos pelo Supabase e não são públicos.
          </small>
        </div>
      </section>
    </main>
